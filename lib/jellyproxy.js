     ...
     //register frames
       ...
       var clientError = function (e) { 
         if (!res._header) {
           res.writeHead(502, {})
           res.end();
           _this.log("client error "+e.stack)  // This should be debug only.
         } else {
           res.end();
           _this.log("client error after writeHead was called. "+e.stack) // This should not be debug, it should always display because it's really bad!
         }
       }  
